...
export const SETUP_ITEMS: SetupItem[] = [
  {
    ...
    priority: 'agora',
    steps: [
      'Use um projeto Vercel exclusivo para o Gabriel Vitrini',
      'ROM_PANEL e NEXT_PUBLIC_ROM_PANEL com o valor vitrini',
      'DATABASE_URL = Neon dedicado só ao Gabriel Vitrini',
  ...
  },
  {
    ...
    steps: [
      ...
      'Defina credenciais novas; não reutilize usuários ou senhas de outra unidade',
